const translations = {
    es: {
      ...
      description: 'Describe tu sueño y obtén una interpretación profesional.',
      bullet1Title: 'Sé Breve y Claro',
      bullet1: 'Describe tu sueño como si se lo contaras a un amigo.',
      bullet2Title: 'Contexto Inicial',
      bullet2: 'Menciona el lugar, personas, acciones y todo detalle relevante.',
      ...
      bullet5: 'Enumera 2 o 3 cosas que recuerdes claramente.',
      bullet6Title: 'Final',
  ...
  `,
    ...
    en: {
      ...
      description: 'Describe your dream and receive a professional interpretation.',
      ...
      bullet5: 'List 2-3 things you clearly remember.',
      bullet6Title: 'Ending',
